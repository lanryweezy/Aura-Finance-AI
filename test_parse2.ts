...
console.log(safeParseJSON<any>('{"test": 123}'));
console.log(safeParseJSON<any>('```json\n[{"test": 123}]\n```'));
console.log(safeParseJSON<any>('some text before\n{"test": 123}\nsome text after'));
console.log(safeParseJSON<any>('malformed json'));
