...
export const ocrService = {
    scanReceipt: async (file: File): Promise<ReceiptData> => {
        ...
        try {
            ...
            const systemInstruction = `You are an AI assistant. Analyze the provided receipt image and extract the following: Merchant, Date (YYYY-MM-DD), Total Amount, Description, and Category. The Category MUST be exactly one of the following: [${categories}]. Return as JSON.`;
