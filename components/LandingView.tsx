    ...
    <div className="min-h-screen bg-dark-primary text-white font-sans selection:bg-brand-cyan selection:text-black">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="bg-gradient-to-br from-brand-cyan to-brand-purple p-2 rounded-xl shadow-lg">
              <Cpu size={24} className="text-black stroke-[2.5]" />
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <div key={i} className="group p-8 bg-white/5 border border-white/10 rounded-[2rem] hover:bg-white/10 transition-all duration-300">
      ...
      <section className="py-20 border-y border-white/5 bg-white/[0.02]">
        <div className="max-w-7xl mx-auto px-4 text-center">
          <p className="text-[10px] font-black uppercase tracking-[0.4em] text-gray-500 mb-10">Trusted by modern teams across Lagos & Abuja</p>
          <div className="flex flex-wrap justify-center items-center gap-12 opacity-30 grayscale invert">
            <img src="https://upload.wikimedia.org/wikipedia/commons/b/ba/Paystack_logo.png" alt="Paystack" className="h-6" />
            <img src="https://upload.wikimedia.org/wikipedia/commons/4/4b/Flutterwave_Logo.png" alt="Flutterwave" className="h-4" />
            <img src="https://upload.wikimedia.org/wikipedia/commons/e/e1/Kuda_Bank_logo.png" alt="Kuda" className="h-6" />
            <img src="https://upload.wikimedia.org/wikipedia/commons/1/15/Andela_logo.png" alt="Andela" className="h-6" />
          </div>
        </div>
      </section>
