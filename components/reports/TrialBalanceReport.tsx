                ...
                <table className="w-full">
                    <thead>
                        <tr className="bg-gray-50 dark:bg-white/5 border-b border-gray-100 dark:border-gray-800">
                            <th className="p-4 text-left text-xs font-bold uppercase tracking-wider text-gray-500 dark:text-gray-400">Account</th>
                            <th className="p-4 text-right text-xs font-bold uppercase tracking-wider text-gray-500 dark:text-gray-400">Debit ({currency})</th>
                            <th className="p-4 text-right text-xs font-bold uppercase tracking-wider text-gray-500 dark:text-gray-400">Credit ({currency})</th>
                        </tr>
                    </thead>
                    <tbody className="divide-y divide-gray-50 dark:divide-gray-800/50">
                        {balances.map(item => {
                            ...
                            return (
                                <tr key={item.name} className="hover:bg-gray-50 dark:hover:bg-white/5 transition-colors">
                                    <td className="p-4 text-sm font-bold text-gray-900 dark:text-white">{item.name}</td>
                    ...
                    <tfoot>
                        <tr className="trial-balance-total bg-gray-50 dark:bg-dark-secondary/20">
                            <td className="p-4 font-black text-gray-900 dark:text-white">Total</td>
