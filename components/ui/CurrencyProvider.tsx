...
interface CurrencyContextType {
    ...
    formatAmount: (amount: number, options?: { compact?: boolean; maximumFractionDigits?: number }) => string;
}
...
export const CurrencyProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
    ...
    const formatAmount = (amount: number, options?: { compact?: boolean; maximumFractionDigits?: number }) => {
