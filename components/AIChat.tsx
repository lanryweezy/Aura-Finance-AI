...
export const AIChat: React.FC<AIChatProps> = ({ transactions, bills, invoices }) => {
  ...
  useEffect(() => {
    ...
    // AI Quality: Centralized client and key validation check to avoid local initialization
    // and rely on application-level error fallbacks and configuration details.
    if(aiClient && API_KEY) {
