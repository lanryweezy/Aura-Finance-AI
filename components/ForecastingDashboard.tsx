...
export const ForecastingDashboard: React.FC = () => {
  ...
  const forecast = useMemo(() => {
    ...
    return generateCashFlowForecast(transactions, invoices, bills, payrollHistory);
      ...
      <div className="space-y-1.5 mb-4">
        {forecast.forecasts.map((f, i) => (
          <div key={i} className="flex items-center text-xs">
            ...
            <div className="flex-1 h-4 bg-dark-primary rounded-full overflow-hidden mx-2">
              <div className={`h-full rounded-full ${f.netCashFlow >= 0 ? 'bg-green-500' : 'bg-red-500'}`}
